...
ClapTrap::ClapTrap()
{
	...
	EnergyPoints = 10;
	AttackDammage = 0;
	std::cout << "the constructor by default of the Claptrap has been called." << std::endl;
}
...
ClapTrap::ClapTrap(std::string const NameGiven)
{
	...
	EnergyPoints = 10;
	AttackDammage = 0;
	std::cout << "the constructor of the ClapTrap has been called." << std::endl;
}

ClapTrap::ClapTrap(ClapTrap &copy)
{
	*this = copy;
	std::cout << "the constructor by copy of the ClapTrap has been called." << std::endl;
}

ClapTrap::~ClapTrap(void)
{
	std::cout << "the destructor of the ClapTrap has been called." << std::endl;
}
